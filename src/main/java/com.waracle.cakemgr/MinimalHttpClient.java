...
class MinimalHttpClient {
    static InputStream httpGet(String url, String mimeType) throws IOException {
    ...
    static List<CakeEntity> httpGetJson(String url) throws IOException {
        return new ObjectMapper().readValue(httpGet(url, "application/json"), new TypeReference<List<CakeEntity>>(){});
    }

    static String httpGetHtml(String url) throws IOException {
